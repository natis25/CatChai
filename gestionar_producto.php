    ...
    <table>
        ...
        while ($row = $result->fetch_assoc()) {
            echo "<tr>
                    ...
                    <td>{$row['Categoria']}</td>
                    <td>
                        <button type='button' onclick='mostrarFormulario({$row['idProducto']}, \"{$row['Producto']}\", {$row['Precio']}, \"{$row['Descripcion']}\", {$row['Disponibilidad']}, {$row['Categoria_idCategoria']})'>Modificar</button>
