...
<body>
    ...
    <form action="procesar_promocion.php" method="post">
        ...
        <button class="btn" type="submit" name="accion" value="editar">Editar Promoción</button>
        <button class="btn" type="submit" name="accion" value="eliminar">Eliminar Promoción</button>
    </form>
